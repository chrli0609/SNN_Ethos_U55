...
def gen_fc_lif_no_layer_wise_update(INPUT_LAYER_SIZE, OUTPUT_LAYER_SIZE, 
         weights_volume_ohwi, bias_list, beta_list, vth_list,
         cms_name, weights_and_biases_on_sram, is_last_layer, NUM_TIME_STEPS,
    ...
    npu_op_list = layer_merge_and_write(cms_name, header_out_filepath)
    generate_dict_for_writing_defines_to_C_files(cms_name, weight_byte_arr_init, bias_byte_arr_init)
