...
for i in range(NUM_LAYERS+1):
    if (i == 0):
        INIT_LAYER_SIZES_LIST.append(28*28)
    elif (i == NUM_LAYERS):
        INIT_LAYER_SIZES_LIST.append(10)
    else:
        INIT_LAYER_SIZES_LIST.append(48)
...
for i in range(NUM_LAYERS):
    MEM_STORE_LOC_LIST.append("model_params_sram0")
    WEIGHTS_AND_BIASES_ON_SRAM_LIST.append(False)
    LIF_PARAMS_ON_SRAM_LIST.append(False)
...
IN_CURR_MAX_VAL_LIST = []
IN_CURR_MIN_VAL_LIST = []
DECAYED_MEM_MAX_VAL_LIST = []
DECAYED_MEM_MIN_VAL_LIST = []
V_MEM_MAX_VAL_LIST = []
V_MEM_MIN_VAL_LIST = []

for i in range(NUM_LAYERS):
    IN_CURR_MAX_VAL_LIST.append(IN_CURR_MAX_VAL)
    IN_CURR_MIN_VAL_LIST.append(IN_CURR_MIN_VAL)
    DECAYED_MEM_MAX_VAL_LIST.append(DECAYED_MEM_MAX_VAL)
    DECAYED_MEM_MIN_VAL_LIST.append(DECAYED_MEM_MIN_VAL)
    V_MEM_MAX_VAL_LIST.append(V_MEM_MAX_VAL)
    V_MEM_MIN_VAL_LIST.append(V_MEM_MIN_VAL)