...
from data_structs import MemoryAllocator, Region, Tensor 
from config_ops import *
#from config_ops import gen_weights_and_biases
from extra_func import get_block_config, gen_cms
from write_connectivity_h_file import write_init_func
from write_layer_files import write_cms_to_files

# Move this to write_layer_files eventually
#from write_connectivity_h_file import write_tensor_declarations
...
def gen_fc_lif(INPUT_LAYER_SIZE, OUTPUT_LAYER_SIZE, 
    ...
    # Define input and output of the NPU Operation Chain
    ...
    #write_tensor_declarations(header_out_filepath, mem_alloc, layer_base_name, layer_num, mem_store_loc)
