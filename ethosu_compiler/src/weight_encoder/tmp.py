...
def test_encode_weights(
    ...
    print("accelerator:", arch.__class__, "\n", arch)
    print("weights_volume:", weights_ohwi.__class__, "\n", weights_ohwi.shape)
...
arch = NpuAccelerator.Ethos_U55_256
dilation_x = 1
dilation_y = 1
ifm_bitdepth = 8
depth_control = 1
#weights_shape_and_block_depth = ((16, 16, 16, 16), 8)
weights_shape_and_block_depth = ((16, 2, 2, 16), 16)
test_encode_weights(
    arch=arch,
    ...
    weights_shape_and_block_depth=weights_shape_and_block_depth
)