...
| NPU_SET_OFM_BASE0         | 0         | 0x00001bf0 (7152)       |
...
| NPU_SET_OFM_DEPTH_M1      | 527       | -                       |
| NPU_SET_OFM_STRIDE_C      | 0         | 0x00000001 (1)          |
| NPU_SET_OFM_STRIDE_Y      | 0         | 0x00000210 (528)        |
| NPU_SET_OFM_STRIDE_X      | 0         | 0x00000210 (528)        |
...
| NPU_SET_IFM2_BASE0        | 0         | 0x000019e0 (6624)       |
...
| NPU_SET_IFM2_STRIDE_Y     | 0         | 0x00000210 (528)        |
| NPU_SET_IFM2_STRIDE_X     | 0         | 0x00000210 (528)        |
...
| NPU_SET_DMA0_LEN          | 0         | 0x000015c0 (5568)       |
| NPU_OP_DMA_START          | 0         | -                       |
...
| NPU_SET_OFM_BASE0         | 0         | 0x00001e00 (7680)       |
...
| NPU_SET_WEIGHT_BASE       | 0         | 0x000016b0 (5808)       |
| NPU_SET_WEIGHT_LENGTH     | 0         | 0x00000120 (288)        |
| NPU_SET_SCALE_REGION      | 1         | -                       |
| NPU_SET_SCALE_BASE        | 0         | 0x00000210 (528)        |
| NPU_SET_SCALE_LENGTH      | 0         | 0x000014a0 (5280)       |
| NPU_SET_IFM_IB_END        | 10        | -                       |
| NPU_SET_AB_START          | 30        | -                       |
| NPU_SET_BLOCKDEP          | 3         | -                       |
| NPU_OP_DMA_WAIT           | 0         | -                       |
| NPU_OP_CONV               | 0         | -                       |
| NPU_SET_OFM_SCALE         | 36        | 0x40404080 (1077952640) |
| NPU_SET_IFM_BASE0         | 0         | 0x000017d0 (6096)       |
| NPU_SET_IFM_DEPTH_M1      | 527       | -                       |
| NPU_SET_IFM_STRIDE_Y      | 0         | 0x00000210 (528)        |
| NPU_SET_IFM_STRIDE_X      | 0         | 0x00000210 (528)        |
| NPU_SET_OFM_BASE0         | 0         | 0x00001bf0 (7152)       |
...
| NPU_SET_IFM_IB_END        | 46        | -                       |
| NPU_SET_AB_START          | 46        | -                       |
| NPU_SET_IFM2_BASE0        | 0         | 0x00001bf0 (7152)       |
| NPU_OP_ELEMENTWISE        | 0         | -                       |
| NPU_SET_OPA_SCALE         | 13        | 0x55555555 (1431655765) |
| NPU_SET_OPB_SCALE         | 0         | 0x00000000 (0)          |
| NPU_SET_OFM_SCALE         | 50        | 0x60000000 (1610612736) |
| NPU_SET_IFM_BASE0         | 0         | 0x00001bf0 (7152)       |
| NPU_SET_IFM_PRECISION     | 257       | -                       |
| NPU_SET_OFM_BASE0         | 0         | 0x000017d0 (6096)       |
| NPU_SET_IFM2_BASE0        | 0         | 0x00001e00 (7680)       |
| NPU_SET_BLOCKDEP          | 0         | -                       |
...
| NPU_SET_OFM_BASE0         | 0         | 0x00002020 (8224)       |
...
| NPU_SET_OFM_BASE0         | 0         | 0x00001e00 (7680)       |
| NPU_SET_IFM2_REGION       | 1         | -                       |
| NPU_SET_IFM2_BASE0        | 0         | 0x00002020 (8224)       |
| NPU_SET_IFM2_ZERO_POINT   | 65408     | -                       |
| NPU_OP_ELEMENTWISE        | 0         | -                       |
...
| NPU_SET_IFM2_BASE0        | 0         | 0x00001e00 (7680)       |
| NPU_OP_ELEMENTWISE        | 2         | -                       |
| NPU_SET_IFM_BASE0         | 0         | 0x00002020 (8224)       |
| NPU_SET_IFM_PRECISION     | 1         | -                       |
| NPU_SET_OFM_BASE0         | 0         | 0x00002010 (8208)       |
...
| NPU_SET_IFM_IB_END        | 10        | -                       |
| NPU_SET_AB_START          | 30        | -                       |
| NPU_SET_OFM_SCALE         | 9         | 0x401fbfe0 (1075822560) |
| NPU_SET_BLOCKDEP          | 3         | -                       |
| NPU_OP_POOL               | 2         | -                       |
| NPU_SET_OFM_SCALE         | 30        | 0x40000000 (1073741824) |
| NPU_SET_IFM_BASE0         | 0         | 0x000019e0 (6624)       |
| NPU_SET_OFM_BASE0         | 0         | 0x000019e0 (6624)       |
| NPU_SET_OFM_DEPTH_M1      | 527       | -                       |
| NPU_SET_OFM_STRIDE_Y      | 0         | 0x00000210 (528)        |
| NPU_SET_OFM_STRIDE_X      | 0         | 0x00000210 (528)        |
