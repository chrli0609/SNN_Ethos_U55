...
| NPU_SET_OFM_BASE0         | 0         | 0x00000890 (2192)       |
...
| NPU_SET_IFM2_BASE0        | 0         | 0x00000810 (2064)       |
...
| NPU_SET_DMA0_DST          | 0         | 0x00000080 (128)        |
| NPU_SET_DMA0_LEN          | 0         | 0x00000710 (1808)       |
| NPU_OP_DMA_START          | 0         | -                       |
...
| NPU_SET_OFM_BASE0         | 0         | 0x00000910 (2320)       |
...
| NPU_SET_WEIGHT_BASE       | 0         | 0x00000580 (1408)       |
| NPU_SET_WEIGHT_LENGTH     | 0         | 0x00000210 (528)        |
| NPU_SET_SCALE_REGION      | 1         | -                       |
| NPU_SET_SCALE_BASE        | 0         | 0x00000080 (128)        |
...
| NPU_SET_IFM_BASE0         | 0         | 0x00000790 (1936)       |
| NPU_SET_IFM_DEPTH_M1      | 127       | -                       |
| NPU_SET_IFM_STRIDE_Y      | 0         | 0x00000080 (128)        |
| NPU_SET_IFM_STRIDE_X      | 0         | 0x00000080 (128)        |
| NPU_SET_OFM_BASE0         | 0         | 0x00000890 (2192)       |
...
| NPU_SET_IFM_IB_END        | 46        | -                       |
| NPU_SET_AB_START          | 46        | -                       |
| NPU_SET_IFM2_BASE0        | 0         | 0x00000890 (2192)       |
| NPU_OP_ELEMENTWISE        | 0         | -                       |
| NPU_SET_OPA_SCALE         | 13        | 0x55555555 (1431655765) |
| NPU_SET_OPB_SCALE         | 0         | 0x00000000 (0)          |
| NPU_SET_OFM_SCALE         | 50        | 0x60000000 (1610612736) |
| NPU_SET_IFM_BASE0         | 0         | 0x00000890 (2192)       |
| NPU_SET_IFM_PRECISION     | 257       | -                       |
| NPU_SET_OFM_BASE0         | 0         | 0x00000790 (1936)       |
| NPU_SET_IFM2_BASE0        | 0         | 0x00000910 (2320)       |
| NPU_SET_BLOCKDEP          | 0         | -                       |
...
| NPU_SET_OFM_BASE0         | 0         | 0x000009a0 (2464)       |
...
| NPU_SET_ACTIVATION        | 0         | -                       |
| NPU_SET_IFM2_REGION       | 1         | -                       |
| NPU_SET_IFM2_BASE0        | 0         | 0x000009a0 (2464)       |
| NPU_SET_IFM2_ZERO_POINT   | 65408     | -                       |
| NPU_OP_ELEMENTWISE        | 0         | -                       |
...
| NPU_SET_IFM_BASE0         | 0         | 0x00000810 (2064)       |
| NPU_SET_IFM_PRECISION     | 1         | -                       |
| NPU_SET_OFM_BASE0         | 0         | 0x00000810 (2064)       |
