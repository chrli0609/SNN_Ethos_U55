...
def main():
	...
	# mW
	models_power_consumption = [98.9967, 100.287, 100.188, 100.6401]


	# Inference frequency
	inference_frequency = 1 / (0.6 * 10**-3)	# 0.6 ms period
	...
	for i in range(len(layer_sizes_list)):
		...
		tot_energy_efficiency = tot_num_synops * inference_frequency / (10**9 * models_power_consumption[i]*10**-3)
		print(f"Energy Efficiency: {tot_energy_efficiency} GSOPS/W")
