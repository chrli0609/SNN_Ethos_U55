...
plot_store_dir = Path("../plots/cache/")
...
# Data
inference_time_enabled = [322.113778, 423.854222, 502.585778, 525.008889]
inference_time_disabled = [122.086222, 162.109333, 187.924444, 219.597333]

power_enabled = [98.9967, 100.287, 100.188, 100.6401]
power_disabled = [100.782, 103.2768, 104.4285, 104.5176]
