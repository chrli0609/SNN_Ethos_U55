...
python3 gen_model_cpp.py --tflite_path membrane_update_test/saved_models/tflite_vela/tflite_model_vela.tflite --output_dir membrane_update_test/saved_models/cpp_tflite_vela
